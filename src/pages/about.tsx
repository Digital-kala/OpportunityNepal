  ...
  return (
    <Layout pageTitle="About">
      <div className="bg_website_ddblue py-12 md:px-16 pt-[20vh] pb-2 md:pb-[4vh] flex flex-col items-center">
        ...
        <p className="text-slate-50 text-sm md:text-lg">
      ...
      <section className="container mx-auto px-10 py-20 md:p-32">
        <div className="text-center text-lg leading-8">
          ...
          <p className="leading-7">
            ...
            Digital Kala is leading the charge in revolutionizing educational
            opportunities for Nepalese students with the introduction of our
            one-stop scholarship platform. Our mission is clear: to establish a
            comprehensive resource that not only aggregates national and
            international scholarships but also acts as a catalyst for
            empowerment, opening doors to a brighter future.
          </p>
        </div>
      </section>
      ...
      <div className="bg_website_dblue text-white">
        <section className="container mx-auto px-10 py-20 md:p-32">
          <div className="text-center text-lg leading-8">
            ...
            <br />
            <p className="leading-7">
              In a world increasingly interconnected and driven by technology,
              the need for digital literacy and awareness has never been more
              crucial. We are excited to introduce the Digital Kala initiative,
              an endeavor that aims to empower young minds with vital digital
              literacy skills. In the age of rapid technological advancements,
              ensuring that students are well-equipped to navigate the digital
              world responsibly is paramount. Digital Kala strives to achieve
              this by imparting knowledge and fostering awareness regarding
              digital safety, responsible gadget usage, and the limitless
              potential that the digital realm offers.
            </p>
          </div>
        </section>
      </div>
